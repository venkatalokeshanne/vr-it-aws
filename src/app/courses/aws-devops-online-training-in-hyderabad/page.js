            ...
            {courseData.heroImageUrl && (
              <div className="mb-8 relative aspect-[1200/630] rounded-2xl overflow-hidden mx-auto max-w-4xl">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="inline-flex items-center rounded-full bg-cyan-500/20 backdrop-blur-sm px-3 py-1.5 text-cyan-300 ring-1 ring-cyan-500/30">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-6 mt-8">
                ...
                {courseData.price && courseData.price > 0 && (
                  <div className="text-center">
                    <div className="text-2xl font-bold text-cyan-400" itemProp="offers" itemScope itemType="https://schema.org/Offer">
